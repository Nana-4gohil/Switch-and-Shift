...
namespace Switch_and_Shift.Controllers
{
    public class USERSController : Controller
    {
        ...
        public ActionResult LogIn(USERS uSER)
        {
            ...
            if (checklogin != null && checklogin.report_show == 1)
            {
        ...
        public ActionResult UserReview(int? id)
        {
            ...
            var reviewer = db.USERS.Where(c => c.Email.Equals(email)).FirstOrDefault();
        ...
        {
            var reviewee = db.USERS.Where(c => c.UserId == id).FirstOrDefault();
            var review = db.USERREVIEW.Where(x => x.reviewee_email == reviewee.Email).FirstOrDefault();
